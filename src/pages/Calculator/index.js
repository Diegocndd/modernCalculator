      ...
      <View style={styles.display}>
        <View style={styles.displayRow1}>
          <Text style={styles.textRow1}>
            {isCompleted1 ? number1 : number2} {operation}
          </Text>
        </View>

        <View style={styles.displayRow2}>
          <Text style={styles.result}>{isCompleted1 ? number2 : number1}</Text>
        </View>
      </View>
      ...
      <View style={styles.keyboard}>
        <View style={styles.row}>
          ...
          <TouchableOpacity style={styles.column} onPress={() => clearAll()}>
            <View style={styles.column}>
              <Text style={[styles.keyboardText, {color: secondColor}]}>C</Text>
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.row}>
          ...
          <TouchableOpacity
            ...
            <View style={styles.column}>
              <Text style={[styles.keyboardText, {color: secondColor}]}>+</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.row}>
          <TouchableOpacity
            ...
            <View style={styles.column}>
              <Text style={[styles.keyboardText, {color: secondColor}]}>0</Text>
            </View>
          </TouchableOpacity>
